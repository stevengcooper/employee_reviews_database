...
class EmployeeReviews < Minitest::Test
  ...
  def test_can_get_employee_salary
    a = Department.new(name: "Marketing")
    new_employee = Employee.new(name: "Dan", email: "d@mail.com", phone: "914-555-5555", salary: 50000.00, review: "He's great.")
  ...
  def test_add_employee_review
    xavier = Employee.new(name: "Xavier", email: "ProfX@marvel.com", phone: "911", salary: 70000.00, review: nil)
    assert xavier.reviews << positive_review_one
  end
  ...
  def test_department_raises_based_on_criteria
    ...
    xavier = Employee.new(name: "Xavier", email: "ProfX@marvel.com", phone: "911", salary: 70000.00, review: nil)
    new_employee = Employee.new(name: "Dan", email: "d@mail.com", phone: "914-555-5555", salary: 50000.00, review: nil)
    old_employee = Employee.new(name: "Yvonne", email: "Yvonne@urFired.com", phone: "919-123-4567", salary: 40000.00, review: nil)
    a.employees << xavier
    a.employees << new_employee
    a.employess << old_employee
